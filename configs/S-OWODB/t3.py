...
classes = ("aeroplane", "bicycle", "bird", "boat", "bus", "car",
    ...
    "refrigerator", "bed", "toilet", "sofa","frisbee", "skis", "snowboard", "sports ball",
...
voc_dataset_eval = dict(
    ...
    data_root='./datasets',
    test_mode=True,
    ann_file='ImageSets/Main/S-OWODB/test.txt',
...
trlder = dict(
    ...
    dataset=dict(
        ...
        ann_file='ImageSets/Main/S-OWODB/t3.txt',
        batch_shapes_cfg=None,
        data_prefix=dict(
            sub_data_root=''
        ),
